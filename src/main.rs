...
struct Config {
    chronicler_directory: Option<String>,
}
...
fn load_chronicler_directory() -> io::Result<PathBuf> {
...
fn update_chronicler_headers(chronicler_directory: impl AsRef<Path>) -> io::Result<()> {
